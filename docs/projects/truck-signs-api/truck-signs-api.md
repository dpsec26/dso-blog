...
You can view the [**repository**](https://github.com/dpsec26/truck_signs_api) on GitHub.
:::
...
![alt text](./img/Admin_Panel_View_Mobile.png)  ![alt text](./img/Admin_Panel_View_Mobile_2.png) ![alt text](./img/Admin_Panel_View_Mobile_3.png)
...
![alt text](./img/Admin_Panel_View.png)

---

![alt text](./img/Admin_Panel_View_2.png)

---

![alt text](./img/Admin_Panel_View_3.png)
